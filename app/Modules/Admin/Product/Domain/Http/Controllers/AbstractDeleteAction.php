...
abstract class AbstractDeleteAction extends Controller
{
    abstract public function __invoke(Request $request, int $userId, int $productId, AbstractDeleteService $deleteService): JsonResponse;
}
