...
use App\Modules\Admin\User\Interface\Http\Controllers\UserCustomerController;
...
class UserServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(AbstractUserCustomerController::class, UserCustomerController::class);
